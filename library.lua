...
local OrionLib = {
	...
	Folder = nil,
	SaveCfg = false,
	CloseKey = Enum.KeyCode.LeftShift,
}
...
function OrionLib:MakeNotification(NotificationConfig)
	spawn(function()
		...
		TweenService
			:Create(NotificationFrame, TweenInfo.new(0.5, Enum.EasingStyle.Quint), { Position = UDim2.new(0, 0, 0, 0) })
			:Play()

		wait(NotificationConfig.Time - 0.88)
		TweenService
			:Create(NotificationFrame.Icon, TweenInfo.new(0.4, Enum.EasingStyle.Quint), { ImageTransparency = 1 })
			:Play()
		TweenService
			:Create(NotificationFrame, TweenInfo.new(0.8, Enum.EasingStyle.Quint), { BackgroundTransparency = 0.6 })
			:Play()
		wait(0.3)
		TweenService
			:Create(NotificationFrame.UIStroke, TweenInfo.new(0.6, Enum.EasingStyle.Quint), { Transparency = 0.9 })
			:Play()
		TweenService
			:Create(NotificationFrame.Title, TweenInfo.new(0.6, Enum.EasingStyle.Quint), { TextTransparency = 0.4 })
			:Play()
		TweenService
			:Create(NotificationFrame.Content, TweenInfo.new(0.6, Enum.EasingStyle.Quint), { TextTransparency = 0.5 })
			:Play()
		wait(0.05)
...
function OrionLib:MakeWindow(WindowConfig)
	...
	OrionLib.CloseKey = WindowConfig.CloseKey or Enum.KeyCode.LeftShift
	...
	AddConnection(CloseBtn.MouseButton1Up, function()
		...
		OrionLib:MakeNotification({
			...
			Content = "Tap " .. OrionLib.CloseKey.Name .. " to reopen the interface",
			Time = 5,
		})
	...
	AddConnection(UserInputService.InputBegan, function(Input)
		if Input.KeyCode == OrionLib.CloseKey and UIHidden then
		...
		local function GetElements(ItemParent)
			...
			function ElementFunction:AddButton(ButtonConfig)
				...
				AddConnection(Click.MouseEnter, function()
					TweenService
						:Create(ButtonFrame, TweenInfo.new(0.25, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {
			...
			function ElementFunction:AddToggle(ToggleConfig)
				...
				function Toggle:Set(Value)
					...
					TweenService
						:Create(ToggleBox.Ico, TweenInfo.new(0.3, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {
				...
				AddConnection(Click.MouseEnter, function()
					TweenService
						:Create(ToggleFrame, TweenInfo.new(0.25, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {
							BackgroundColor3 = Color3.fromRGB(
								OrionLib.Themes[OrionLib.SelectedTheme].Second.R * 255 + 3,
								OrionLib.Themes[OrionLib.SelectedTheme].Second.G * 255 + 3,
								OrionLib.Themes[OrionLib.SelectedTheme].Second.B * 255 + 3
					...
					if #Dropdown.Options > MaxElements then
						TweenService
							:Create(
								...
								TweenInfo.new(0.15, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
								{
									Size = Dropdown.Toggled and UDim2.new(1, 0, 0, 38 + (MaxElements * 28))
			...
			function ElementFunction:AddBind(BindConfig)
				...
				AddConnection(UserInputService.InputBegan, function(Input)
					...
					if
						(Input.KeyCode.Name == Bind.Value or Input.UserInputType.Name == Bind.Value)
				...
				AddConnection(Click.MouseEnter, function()
					TweenService
						:Create(BindFrame, TweenInfo.new(0.25, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {
							BackgroundColor3 = Color3.fromRGB(
								OrionLib.Themes[OrionLib.SelectedTheme].Second.R * 255 + 3,
								OrionLib.Themes[OrionLib.SelectedTheme].Second.G * 255 + 3,
								OrionLib.Themes[OrionLib.SelectedTheme].Second.B * 255 + 3
			...
			function ElementFunction:AddTextbox(TextboxConfig)
				...
				AddConnection(Click.MouseEnter, function()
					TweenService
						:Create(TextboxFrame, TweenInfo.new(0.25, Enum.EasingStyle.Quint, Enum.EasingDirection.Out), {
							BackgroundColor3 = Color3.fromRGB(
								OrionLib.Themes[OrionLib.SelectedTheme].Second.R * 255 + 3,
								OrionLib.Themes[OrionLib.SelectedTheme].Second.G * 255 + 3,
								OrionLib.Themes[OrionLib.SelectedTheme].Second.B * 255 + 3
